<div class="dark:bg-gray-800 dark:border-gray-700 max-w-sm bg-white border border-gray-200 rounded-lg shadow">
    ...
    <div class="p-5">
        <header class="lg:mb-6 not-format">
            ...
            <address class="flex items-center mb-6 not-italic">
                <div class="dark:text-white inline-flex items-center mr-3 text-sm text-gray-900">
                    <img class="w-8 h-8 mr-4 rounded-full" src="{{ $post->user->profile_photo_url }}" alt="Jese Leos">
                    <div>
                        <a href="#" rel="author"
                            class="dark:text-white font-bold text-gray-900">{{ $post->user->name }}</a>
        ...
        <a href="#">
            <h5 class="dark:text-white mb-2 text-2xl font-bold tracking-tight text-gray-900">{{ $post->title }}</h5>
        </a>
